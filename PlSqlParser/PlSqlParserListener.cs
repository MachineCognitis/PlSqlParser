...
namespace PlSqlParser
{
	...
	public interface IPlSqlParserListener : IParseTreeListener
	{
		...
		/// </summary>
		/// <param name="context">The parse tree.</param>
		void EnterQuantitative_where_stmt([NotNull] PlSqlParser.Quantitative_where_stmtContext context);
		/// <summary>
		/// Exit a parse tree produced by <see cref="PlSqlParser.quantitative_where_stmt"/>.
		/// </summary>
		/// <param name="context">The parse tree.</param>
		void ExitQuantitative_where_stmt([NotNull] PlSqlParser.Quantitative_where_stmtContext context);
		/// <summary>
