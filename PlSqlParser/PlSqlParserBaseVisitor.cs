...
namespace PlSqlParser
{
	...
	public partial class PlSqlParserBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, IPlSqlParserVisitor<Result>
	{
		...
		/// <summary>
		/// Visit a parse tree produced by <see cref="PlSqlParser.quantitative_where_stmt"/>.
		/// <para>
		/// The default implementation returns the result of calling <see cref="AbstractParseTreeVisitor{Result}.VisitChildren(IRuleNode)"/>
		/// on <paramref name="context"/>.
		/// </para>
		...
		/// <param name="context">The parse tree.</param>
		/// <return>The visitor result.</return>
		public virtual Result VisitQuantitative_where_stmt([NotNull] PlSqlParser.Quantitative_where_stmtContext context) { return VisitChildren(context); }
		/// <summary>
